        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-6 shadow-purple-glow" style={{ background: 'linear-gradient(135deg, #8B5CFF 0%, #5A2FE6 100%)' }}>
              <IoShieldCheckmark size={40} color="#F8F9FA" />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <main className="lg:col-span-3">
              <div className="space-y-8">
                {/* Introduction */}
                <section id="introduction" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoDocumentText size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">Introduction</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                    ...
                    <div className="rounded-xl p-4 border-l-4" style={{ background: 'rgba(16, 185, 129, 0.1)', borderColor: '#10B981' }}>
                ...
                {/* Section 1 */}
                <section id="not-collect" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoEyeOff size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">1. Information We DO NOT Collect</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                {/* Section 2 */}
                <section id="temp-process" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoTime size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">2. Information We Temporarily Process</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                {/* Section 3 */}
                <section id="device-info" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoPhonePortrait size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">3. Device Information Collected by Expo/React Native</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                <section id="third-party" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-3xl font-bold text-offWhite">4. Third-Party Services</h2>
                  </div>
                  <div className="space-y-6">
                    ...
                    {/* Google Gemini AI */}
                    <div className="rounded-xl p-6 border" style={{ background: 'rgba(139, 92, 255, 0.05)', borderColor: 'rgba(139, 92, 255, 0.3)' }}>
                      <h3 className="font-bold text-offWhite mb-3 text-lg">Google Gemini AI</h3>
                      <p className="text-gray-300 leading-relaxed">
                    ...
                    {/* Google AdMob */}
                    <div className="rounded-xl p-6 border" style={{ background: 'rgba(139, 92, 255, 0.05)', borderColor: 'rgba(139, 92, 255, 0.3)' }}>
                      <h3 className="font-bold text-offWhite mb-3 text-lg">Google AdMob (Advertising)</h3>
                      <p className="text-gray-300 leading-relaxed mb-3">
                        The app displays advertisements via Google AdMob. AdMob may collect:
                      </p>
                      <ul className="space-y-2 ml-6 list-disc text-gray-300 mb-3">
                      ...
                      <div className="rounded-lg p-4 mb-3" style={{ background: 'rgba(245, 158, 11, 0.1)', border: '1px solid rgba(245, 158, 11, 0.3)' }}>
                        <div className="flex items-start gap-3">
                        <span className="flex-shrink-0 mt-1">
                          <IoWarning size={20} color="#F59E0B" />
                        </span>        
                    ...
                    {/* Expo Platform */}
                    <div className="rounded-xl p-6 border" style={{ background: 'rgba(139, 92, 255, 0.05)', borderColor: 'rgba(139, 92, 255, 0.3)' }}>
                      <h3 className="font-bold text-offWhite mb-3 text-lg">Expo Platform</h3>
                      <p className="text-gray-300 leading-relaxed">
                ...
                {/* Section 5 */}
                <section id="local-storage" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoLockClosed size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">5. Local Data Storage</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                {/* Section 6 */}
                <section id="security" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoShieldCheckmark size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">6. Data Security</h2>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Section 7 */}
                <section id="children" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoPeople size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">7. Children's Privacy (COPPA Compliance)</h2>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
                ...
                {/* Section 8 */}
                <section id="rights" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoCheckmarkCircle size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">8. Your Rights and Choices</h2>
                  </div>
                  <ul className="space-y-3 ml-6 list-disc text-gray-300 leading-relaxed">
                    <li>
                ...
                {/* Section 8b - GDPR */}
                <section id="gdpr" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoGlobeOutline size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">8b. GDPR Rights (For European Users)</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                    <p>
                ...
                {/* Section 8c - CCPA */}
                <section id="ccpa" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoGlobeOutline size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">8c. California Privacy Rights (CCPA)</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                ...
                {/* Section 9 */}
                <section id="international" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="p-3 rounded-xl bg-gradient-purple-dark">
                      <IoGlobeOutline size={24} color="#8B5CFF" />
                    </div>
                    <h2 className="text-3xl font-bold text-offWhite">9. International Users</h2>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section id="changes" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-3xl font-bold text-offWhite">10. Changes to This Privacy Policy</h2>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <section id="contact" className="glass-card p-8 rounded-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-3xl font-bold text-offWhite">11. Contact Us</h2>
                  </div>
                  <div className="space-y-4 text-gray-300 leading-relaxed">
                    ...
                    <div className="rounded-xl p-6" style={{ background: 'rgba(139, 92, 255, 0.1)', border: '1.5px solid rgba(139, 92, 255, 0.3)' }}>
                      ...
                      <p className="text-sm">Developer: ChartMasterAI Team</p>
                    </div>
                  </div>
                </section>
